...
Event.prototype.parse = function() {
  ...
  } else if (this.event.type === 'subsquestion') {
    event = new Question(this.block, this.event);
  } else if (this.event.type === 'section') {
    event = new Contribution(this.block, this.event);
